...
p=argparse.ArgumentParser();p.add_argument('--title',required=True);p.add_argument('--note-file',required=True);p.add_argument('--image',action='append',default=[]);p.add_argument('--push',action='store_true');a=p.parse_args()
...
paths=['topology/JOURNAL.md','topology/journal_entries.json',*a.image]
