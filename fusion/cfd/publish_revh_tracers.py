...
<figcaption>Moving particles and fading trails follow the saved in-plane velocity over the pressure field, through {report['last_time_s']*1000:.4f} ms. {report['video_duration_s']:.2f} seconds at 60 fps and about 1/200th speed. This is a projected 2D visualization with interpolation between recorded samples, not a reconstruction of full 3D particle paths. <a href="latest-tracers.mp4">Open or download the latest moving-tracer MP4</a> · <a href="latest-tracers.json">Method and provenance</a>.</figcaption></figure>'''
